...
function Player(x, y)
{
  return {
    ...
    jumping: false,
    hp: 3,
    sprite: new Sprite(spritesheet, 235, 27, 10, 18),
    ...
    input: function()
    {
      ...
      {
        GLOBAL.GRAVITY *= -1;
        this.sprite.y = GLOBAL.GRAVITY < 0 ? 45 : 27;
      ...
      this.sprite.x = this.facing === 0 ? 235 : 246;
...
(function()
{
  ...
  GLOBAL.LEVELS = [`0,864,500|1|2,-192,-320,32,32|2,672,800,448,352|2,-160,-320,32,32|2,1120,480,352,672|2,-128,-352,32,32|2,192,480,480,672|2,192,224,1280,256|2,1504,480,32,32|`];
})();

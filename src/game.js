  ...
  for(let i = 0; i < tilemap.length; i++)
  {
    ...
    if (tileData.length > 3)
    {
      const STARTX = parseInt(tileData[1]),
            ...
            ENDX = parseInt(tileData[3]),
            ENDY = parseInt(tileData[4]);
